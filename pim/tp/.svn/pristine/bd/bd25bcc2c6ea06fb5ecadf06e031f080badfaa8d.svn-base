...
procedure Test_TH is
	...
	-- Instanciation du la Table de hashage TH_String_Integer1 avec:
	-- Les Cle en Unbounded_String, les Donnee en Integer, la Capacite de 10
	-- La fonction de hashage taille de Cle au modulo 10.
	...
	begin
		...
		for I in 1..Nb_Cles loop
			...
			if Bavard then
				Put_Line ("Après insertion de la clé " & Cles (I) & " de hash: ");
